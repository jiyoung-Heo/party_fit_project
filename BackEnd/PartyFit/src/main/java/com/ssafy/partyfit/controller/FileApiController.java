...
public class FileApiController {
    ...
    public ResponseEntity<?> uploadEditorImage(@RequestParam("image") final MultipartFile image) {
    	
        if (image.isEmpty()) {
            return new ResponseEntity<String>("empty", HttpStatus.NO_CONTENT);
        }
...
//            }
    ...
    public ResponseEntity<?> printEditorImage(@RequestParam("fileName") final String filename) {
